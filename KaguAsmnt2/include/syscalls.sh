...
# Retrieves file attributes; REG_A contains the file descriptor, returns file attributes in REG_RES or error in REG_ERROR
export SYS_CALL_GET_FILE_ATTR=12

# Sets file attributes; REG_A contains the file descriptor, REG_B contains the new attributes, error in REG_ERROR
